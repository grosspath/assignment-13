...
var getWordCount = function (textString) {
  var arrayOfWords = textString.split(" ")
  var objectFrequency = {}
  for (var i = 0; i < arrayOfWords.length; i++) {
    var someWord = arrayOfWords[i].toLowerCase();
    if (typeof objectFrequency[someWord] === 'undefined'){
      objectFrequency[someWord] = 1
  } else {
    objectFrequency[someWord] = objectFrequency[someWord] + 1
    }
  }
